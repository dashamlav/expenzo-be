...
class Expense(models.Model):
    ...
    date = models.DateField(null=False, blank=False, default=datetime.datetime.today, db_index=True)
    ...
    transactionType = models.CharField(max_length=4, choices=TransactionType.Choices, default=TransactionType.CASH, null=False, blank=False)
